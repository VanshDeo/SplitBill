...
/**
 * Card showing an expense summary. Links to the full expense detail page.
 */
  ...
  return (
    ...
    >
      ...
      {isYourExpense && yourParticipant && (
        ...
        >
          {yourParticipant.settled ? 'Your share settled' : `You owe ${stroopsToXlm(yourParticipant.amountOwed)} XLM`}
        </div>
      )}
